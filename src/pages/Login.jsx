...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    loginWithGoogle();
    setNotification('Successfully signed in with Google!');
    setTimeout(() => {
      navigate('/');
    }, 800);
  };
    ...
    <div className="min-h-[85vh] flex items-center justify-center p-6 max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className={`text-xs leading-relaxed ${
              ...
              Sign in with your Google account or store credentials to access aggregate demand pools, custom procurement builder, and guaranteed group savings.
            </p>
          </div>
        ...
        <div className={`glass-card rounded-3xl p-8 border shadow-2xl transition-all duration-300 ${
          ...
          {/* Success Banner */}
          {notification && (
            <div className="mb-4 p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold flex items-center space-x-2">
          ...
          {!isRegister ? (
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl border border-slate-300 dark:border-slate-700 bg-white hover:bg-slate-50 text-slate-800 text-xs font-bold shadow-sm transition flex items-center justify-center space-x-3 active:scale-95"
              >
