...
import { Layers, Lock, Mail, Store, ShieldCheck, Sparkles, ArrowRight, Eye, EyeOff, CheckCircle2, Truck, Building2 } from 'lucide-react';
import { useApp, DEMO_USERS, DEMO_SUPPLIERS } from '../context/AppContext';

export default function Login() {
  const { 
    theme, t, user, loginWithGoogle, login, switchUser,
    ...
    <div className="min-h-[85vh] flex items-center justify-center p-6 max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full items-center">
        ...
        <div className={`glass-card rounded-3xl p-8 border shadow-2xl transition-all duration-300 ${
          ...
          <div className="grid grid-cols-2 p-1 rounded-2xl bg-slate-100 dark:bg-slate-900 mb-4 border border-slate-200 dark:border-slate-800">
            <button
              type="button"
          ...
          <div className="flex items-center justify-between p-1 rounded-xl bg-slate-100 dark:bg-slate-900/60 mb-6">
            <button
            ...
            >
              {portalType === 'supplier' ? 'Register Supplier' : 'Register Kirana Store'}
            </button>
          </div>
          ...
          {portalType === 'supplier' && isRegister && (
            <form onSubmit={handleRegisterSubmit} className="space-y-3.5 text-xs">
              <div>
                ...
                <input
                  ...
                  className={`w-full border rounded-xl px-3 py-2 ${
                    theme === 'light' ? 'bg-slate-50 border-slate-300' : 'bg-slate-900 border-slate-800 text-white'
                  }`}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  <label className="block text-[11px] font-bold text-slate-400 mb-1">Contact Person</label>
                  <input
                    required
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-400 mb-1">Business Email</label>
                <input
                  type="email"
                  required
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  <label className="block text-[11px] font-bold text-slate-400 mb-1">Warehouse Address</label>
                  <input
